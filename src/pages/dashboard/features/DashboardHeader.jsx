...
const STREAK_STYLES = [
  {
    // 0 - mati
    container:
      "bg-linear-to-br from-slate-400/10 to-slate-500/5 border border-slate-400/20 dark:from-slate-600/20 dark:to-slate-700/10 dark:border-slate-500/25",
  ...
  },
  {
    // 1 - nyala dikit
    container:
      "bg-linear-to-br from-orange-900/15 to-orange-800/8 border border-orange-800/20 dark:from-orange-900/25 dark:to-orange-800/15 dark:border-orange-800/30",
  ...
  },
  {
    // 2
    container:
      "bg-linear-to-br from-orange-600/15 to-orange-500/8 border border-orange-500/22 dark:from-orange-700/22 dark:to-orange-600/12 dark:border-orange-600/28",
  ...
  },
  {
    // 3
    container:
      "bg-linear-to-br from-orange-500/18 to-orange-400/10 border border-orange-400/25 dark:from-orange-600/22 dark:to-orange-500/15 dark:border-orange-500/30",
  ...
  },
  {
    // 4
    container:
      "bg-linear-to-br from-orange-500/22 to-red-500/12 border border-orange-400/30 dark:from-orange-500/25 dark:to-red-500/18 dark:border-orange-400/35",
  ...
  return (
    <div className="flex items-center justify-between">
      ...
      {loading ? (
        ...
        <div
          className={`flex items-center gap-2 px-4 py-2 rounded-2xl transition-all duration-500 ${style.container}`}
        >
          <div className="relative flex items-center justify-center">
            <div
              className={`absolute w-8 h-8 rounded-full blur-sm transition-all duration-500 ${style.glow}`}
            />
            <LucideFlame
          ...
          <div className="flex flex-col leading-tight">
            <span
              className={`text-base font-extrabold tabular-nums transition-all duration-500 ${style.number}`}
            >
              {data?.currentStreak ?? 0}
            </span>
            <span
              className={`text-[10px] font-semibold uppercase tracking-widest transition-all duration-500 ${style.label}`}
            >
