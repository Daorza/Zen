...
function  AuroraBackground({mouseX, mouseY}){
    ...
    const x1 = useSpring(useTransform(mouseY, [0, 1], ["-15%", "15%"]), {stiffness: 40, damping: 20})
    
    const y2 = useSpring(useTransform(mouseX, [0, 1], ["10%", "-10%"]), {stiffness: 25, damping: 18})
    const x2 = useSpring(useTransform(mouseY, [0, 1], ["10%", "-10%"]), {stiffness: 25, damping: 18})
    
    const y3 = useSpring(useTransform(mouseX, [0, 1], ["-8%", "8%"]), {stiffness: 40, damping: 20})
