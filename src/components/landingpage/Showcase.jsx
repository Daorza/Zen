    ...
    <Section>
      <Container>
        <div className="overflow-hidden rounded-2xl border border-slate-700/30 dark:border-slate-50/20 shadow-xl">
          ...
          <nav className="flex items-center justify-between bg-slate-900/40 dark:bg-slate-500/40 px-6 py-4 border border-slate-700/30 dark:border-slate-50/20">
          ...
          <article className="grid grid-cols-1 md:grid-cols-3 min-h-[60vh] bg-transparent border border-slate-700/30 dark:border-slate-50/20">

            <aside className="space-y-4 bg-slate-900/40 dark:bg-slate-500/40 p-6 md:border-r border-slate-700/30 dark:border-slate-50/20 hidden md:block">
            ...
            <section className="flex flex-col justify-end gap-6 p-6 border-y md:border-y-0 md:border-x border-slate-700/30 dark:border-slate-50/20 text-sm">

              <div className="flex justify-end">
                <div className="max-w-xs rounded-2xl rounded-br-sm bg-indigo-700 p-4 text-white">
              ...
              <div className="flex justify-start">
                <div className="max-w-xs rounded-2xl rounded-bl-sm bg-slate-500 p-4 text-white">
                  Siap bos! Jadwal rapat & kerja kelompok sudah masuk ke antrean.
                  Saya bantu ingetin 15 menit sebelumnya ya!
                </div>
              </div>

            </section>

            <aside className="space-y-4 bg-slate-900/40 dark:bg-slate-500/40 p-6 md:border-l border-slate-700/30 dark:border-slate-50/20 hidden md:block">
